...
public class EditarController {
	...
	public String[] retornaAlmacenes(String numVale) throws IOException, ParseException{
		...
		ArrayList<String> alamcenistas;
		System.out.println(ciudad);
		switch(ciudad){
			case " Medellin": 
				alamcenistas=new ArrayList<>();
			...
			case " Rionegro": 
				alamcenistas=new ArrayList<>();
				alamcenistas = almacenistasLdap("AprobadoresRionegro");
				almacenes=new String[alamcenistas.size()];
				for(int i=0;i<alamcenistas.size();i++){
					almacenes[i]=alamcenistas.get(i);
				}				
			...
			case " Avellaneda": 
				alamcenistas=new ArrayList<>();
				alamcenistas = almacenistasLdap("AprobadoresArgentina");
				almacenes=new String[alamcenistas.size()];
				for(int i=0;i<alamcenistas.size();i++){
					almacenes[i]=alamcenistas.get(i);
				}				
			...
			case " Quito": 
				alamcenistas=new ArrayList<>();
				alamcenistas = almacenistasLdap("AprobadoresEcuador");
				almacenes=new String[alamcenistas.size()];
				for(int i=0;i<alamcenistas.size();i++){
					almacenes[i]=alamcenistas.get(i);
				}				
			...
			case " Santiago": 
				alamcenistas=new ArrayList<>();
				alamcenistas = almacenistasLdap("AprobadoresRepDom");
				almacenes=new String[alamcenistas.size()];
				for(int i=0;i<alamcenistas.size();i++){
					almacenes[i]=alamcenistas.get(i);
				}				
