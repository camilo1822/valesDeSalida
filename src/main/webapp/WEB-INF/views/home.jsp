...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
   ...
   <body id="cuerpo" ng-app="validationApp" ng-controller="mainController">
      <header>
         <div id="logo">
            <div id="Custom_Logo">
               <a href="/proveedores/"><img id="ctl00_x63829de2201a4365a3904788f682d0a3" src="resources/img/logo.png" alt="Back to Home"></a>
            </div>
         </div>
         <section class="form-row">
            <section id="breadcrumb-client">
               ...
               <a href="lista">	
                 <input class="botonHome" type="button" id="redirect" name="redirect" value="Ver Lista"
                  class="submit"/>
                 </a>
      ...
      <div class="main-container">
         <section class="form-row">
            ...
            <div class="input-block col-quarter noVale" id="solicita">
               ...
               <input type="text" id="radicado" name="radicado" value="${model.numVale}" readonly/>
               <input type="text" id="isSolicitante" name="isSolicitante" value="${model.esSolicitante}" style="display:none"/>
               <style type="text/css">
                  .messages {
                  color: #FA787E;
                  }
         ...
         <form id="salidaMaterialesForm" name="salidaMaterialesForm" method="post" action="vale" novalidate>
            <section>
            <div class="form-row" id="formularioLogin">
               <div class="input-block col-quarter">
                  <label class="label">Estado:</label>
                  <input type="text" value="${model.estado}" name="estado" readonly/>
               </div>
            </div>
            <div class="form-row">
               <div class="input-block col-quarter">
               ...
               <span ng-if="data.singleSelect=='Si'">
                  <div class="input-block col-quarter" ng-style="visible">
                     ...
                     <input type="text" name="senhores" ng-model="vale.senhores" ng-model-options="{ updateOn: 'blur' }" required />
                     <p class="obligatorio" ng-show="salidaMaterialesForm.senhores.$invalid && salidaMaterialesForm.senhores.$touched">Obligatorio</p>
                  </div>
               </span>
            </div>
            <section>
            ...
            <section>
               ...
               <div class="form-row">
                  <div class="input-block col-quarter">
                     <label class="label"><span class="obligatio">*</span>Diligenciado / Autorizado por:</label>
                     <input type="text" id="diligenciadoPor" name="autorizadoPor" ng-model="vale.autorizadoPor"/>
<!--                      <p class="obligatorio" ng-show="(salidaMaterialesForm.autorizadoPor.$invalid && show) || (salidaMaterialesForm.autorizadoPor.$invalid && salidaMaterialesForm.autorizadoPor.$touched)">Obligatorio</p>
 -->                  </div>
                  <div class="input-block col-quarter">
                     ...
                     <select name="selectMotivo" ng-model="data.selectMotivo" ng-model-options="{ updateOn: 'blur' }" required >
                     ...
                     <p class="obligatorio" ng-show="(salidaMaterialesForm.selectMotivo.$invalid && show) || (salidaMaterialesForm.selectMotivo.$invalid && salidaMaterialesForm.selectMotivo.$touched)">Obligatorio</p>
                  </div>
                  <span ng-if="data.selectMotivo=='Otro'">
                     <div class="input-block col-half">
                        <label class="label respon">Otro - &#191;Cu&aacute;l?</label>						
                        <input type="text" name="cual" ng-model="vale.cual" ng-model-options="{ updateOn: 'blur' }" required />
                        <p class="obligatorio" ng-show="salidaMaterialesForm.cual.$invalid && salidaMaterialesForm.cual.$touched">Obligatorio</p>
                     </div>
                  </span>
               </div>
               <div class="form-row">
                  <div class="input-block col-full">
                     ...
                     <textarea name="justificacion" ng.model="material.justificacion" maxlength="1000" rows="7" ng-model-options="{ updateOn: 'blur' }" required ></textarea>
                     <p class="obligatorio" ng-show="(salidaMaterialesForm.justificacion.$invalid && show) || (salidaMaterialesForm.justificacion.$invalid && salidaMaterialesForm.justificacion.$touched)">Obligatorio</p>
                  </div>
               </div>
            </section>
            <span class="separator"></span>
               ...
               <div class="form-row">
                  <div class="input-block col-half">
                     <div class="input-interno">
                        ...
                        <input class="input-lupa obligatoriedad" type="text" id="codProveedor" name="proveedorId" ng-model="vale.codigo"/>
                        <img class="imgLupa" src="resources/img/lupa.png" alt="Buscar" onclick="obtenerProveedor()"/>
                        <p class="obligatorio obligatoriocodProveedor" style="display:none">Obligatorio</p>
 ...
 -->                     </div>
                  ...
                  <div class="input-block col-half izqui">
                     <div class="input-interno">
                        ...
                        <input class="input-lupa numerico obligatoriedad" id="nitSAP" type="number" name="nit" ng-model="vale.nit"/>
                        <img class="imgLupa" src="resources/img/lupa.png" alt="Buscar" onclick="mostrarListaNit()" ng-click="listaMensajes()"/>
                        <p class="obligatorio obligatorionitSAP" style="display:none">Obligatorio</p>
               ...
               <div class="form-row">
                  <div class="input-block col-half">
                     <div class="input-interno">
                        ...
                        <input class="input-lupa obligatoriedad" type="text" name="empresa" id="nombreSAP" ng-model="vale.empresa"/>
                        <img class="imgLupa" src="resources/img/lupa.png" alt="Buscar" onclick="mostrarLista()" ng-click="listaMensajes()"/>
                        <p class="obligatorio obligatorionombreSAP" style="display:none">Obligatorio</p>
<!--                         <p class="obligatorio lupa1" ng-show="(salidaMaterialesForm.empresa.$invalid && show) || (salidaMaterialesForm.empresa.$invalid && salidaMaterialesForm.empresa.$touched)">Obligatorio</p>
 -->                     </div>
                  ...
                  <div class="input-block col-half izqui">
                     ...
                     <input class="obligatoriedad" type="text" id="direccionSAP" name="direccion" ng-model="vale.direccion" />
                     <p class="obligatorio obligatoriodireccionSAP" style="display:none">Obligatorio</p>
               ...
               <div class="form-row">
                  <div class="input-block col-half">
                     <label class="label"><span class="obligatio">*</span>Nombre contacto:</label>
                     <input class="obligatoriedad" type="text" id="nombresSAP" name="nombreContacto" ng-model="vale.nombreContacto"/>
                     <p class="obligatorio obligatorionombresSAP" style="display:none">Obligatorio</p>
<!--                      <p class="obligatorio" ng-show="(salidaMaterialesForm.nombreContacto.$invalid && show) || (salidaMaterialesForm.nombreContacto.$invalid && salidaMaterialesForm.nombreContacto.$touched)">Obligatorio</p>
 -->                  </div>
                  <div class="input-block col-quarter trio">
                     ...
                     <input type="number" id="telefonoSAP" class="numerico obligatoriedad" name="telefonoContacto" ng-model="vale.telefonoContacto"/>
                     <p class="obligatorio obligatoriotelefonoSAP" style="display:none">Obligatorio</p>
<!--                      <p class="obligatorio" ng-show="(salidaMaterialesForm.telefonoContacto.$invalid && show) || (salidaMaterialesForm.telefonoContacto.$invalid && salidaMaterialesForm.telefonoContacto.$touched)">Obligatorio</p>
 -->                  </div>
                  <div class="input-block col-quarter trio2">
                     ...
                     <input class="obligatoriedad" type="text" id="ciudadSAP" name="ciudadContacto" ng-model="vale.ciudadContacto"/>
                     <p class="obligatorio obligatoriociudadSAP" style="display:none">Obligatorio</p>
<!--                      <p class="obligatorio" ng-show="(salidaMaterialesForm.ciudadContacto.$invalid && show) || (salidaMaterialesForm.ciudadContacto.$invalid && salidaMaterialesForm.ciudadContacto.$touched)">Obligatorio</p>
 -->                  </div>
            ...
            <section>
               ...
               <div class="form-row">
                  <div class="input-block col-half">
                     ...
                     <input type="text" name="nombreRetira" ng-model="vale.nombreRetira" ng-model-options="{ updateOn: 'blur' }" required />
                     <p class="obligatorio" ng-show="(salidaMaterialesForm.nombreRetira.$invalid && show) || (salidaMaterialesForm.nombreRetira.$invalid && salidaMaterialesForm.nombreRetira.touched)">Obligatorio</p>
                  </div>
                  <div class="input-block col-half izqui">
                     <label class="label"><span class="obligatio">*</span>C.C:</label>
                     <input class="numeros" type="number" name="ccRetira" ng-model="vale.ccRetira" ng-model-options="{ updateOn: 'blur' }" required
                        />
                     <p class="obligatorio" ng-show="(salidaMaterialesForm.ccRetira.$invalid && show) || (salidaMaterialesForm.ccRetira.$invalid && salidaMaterialesForm.ccRetira.$touched)">Obligatorio</p>
                  </div>
               </div>
               <div class="form-row">
                  <div class="input-block col-half">
                     <label class="label"><span class="obligatio">*</span>Empresa transporte:</label>
                     <input type="text" name="empresaTransporte" ng-model="vale.empresaTransporte" ng-model-options="{ updateOn: 'blur' }" required
                        />
                     <p class="obligatorio" ng-show="(salidaMaterialesForm.empresaTransporte.$invalid && show) || (salidaMaterialesForm.empresaTransporte.$invalid && salidaMaterialesForm.empresaTransporte.$touched)">Obligatorio</p>
                  </div>
                  <div class="input-block col-half izqui">
                     <label class="label"><span class="obligatio">*</span>Placa veh&iacute;culo:</label>
                     <input type="text" name="placaVehiculo" ng-model="vale.placaVehiculo" ng-model-options="{ updateOn: 'blur' }" required />
                     <p class="obligatorio" ng-show="(salidaMaterialesForm.placaVehiculo.$invalid && show) || (salidaMaterialesForm.placaVehiculo.$invalid && salidaMaterialesForm.placaVehiculo.$touched)">Obligatorio</p>
                  </div>
               </div>
            </section>
            <span class="separator"></span>
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td class="">
                          ...
                          <p class="obligatorio obligatoriedadcentro" style="display:none">Obligatorio</p>
                        </td>
                        ...
                        <td>
                           <input type="text" class="selectUm UmHome obligacionTabla" id="umSOAP" name="um" ng-model="material.um"/>
                  	<p class="obligatorio obligatoriedadumSOAP" style="display:none">Obligatorio</p>
                           <!-- <p class="obligatorio" ng-show="salidaMaterialesForm.um.$invalid && salidaMaterialesForm.um.$touched">Obligatorio</p> -->
                        </td>                     
                        <td>
                           <input class="obligacionTabla cantMat" type="number" name="vlrUnitario" id="vlrUnitarioSAP" ng-model="material.vlrUnitario"/>                         
                        	<p class="obligatorio obligatoriedadvlrUnitarioSAP" style="display:none">Obligatorio</p>
                        </td>
                         <td>
                           <input type="number" name="cantidad" class="cantMat obligacionTabla" id="cantMat"  ng-model="material.cantidad" ng-model-options="{ updateOn: 'blur' }" required min="1"
                              />
                              <p class="obligatorio obligatoriedadcantMat" style="display:none">Obligatorio</p>
                           <!-- <p class="obligatorio" ng-show="salidaMaterialesForm.cantidad.$invalid && salidaMaterialesForm.cantidad.$touched">Obligatorio</p> -->
                        </td>
                        <td>
                           <input type="text" name="valorEstimado" id="vlrEstimado" ng-value="material.cantidad * material.vlrUnitario" ng-model="estimado" readonly/> 
                           <p class="obligatorio obligatoriedadvlrEstimado" style="display:none">Obligatorio</p>
                           <!-- <p class="obligatorio" ng-show="salidaMaterialesForm.valorEstimado.$invalid && salidaMaterialesForm.valorEstimado.$touched">Obligatorio</p> -->
                        </td>
                        <td>
                           <input class="obligacionTabla" type="number" name="peso" id="peso" ng-model="material.peso" ng-model-options="{ updateOn: 'blur' }" required/>
                           <p class="obligatorio obligatoriedadpeso" style="display:none">Obligatorio</p>
                           <!-- <p class="obligatorio" ng-show="salidaMaterialesForm.peso.$invalid && salidaMaterialesForm.peso.$touched">Obligatorio</p> -->
                        </td>
                        <td class="column-eight">
                           <select class="selectForm" name="regresa" id="regresa" ng-model="data.regresa" ng-change="clicRegresa()" onchange="CallPicker()">
                              <option value="Si">Si</option>
                              <option value="No">No</option>
                           </select>
                           <p class="obligatorio" ng-show="salidaMaterialesForm.regresa.$invalid && salidaMaterialesForm.regresa.$touched">Obligatorio</p>
                        </td>
                        <td class="column-eight selectFormTd">
                           <select class="selectForm" name="repuesto" ng-model="data.repuesto" ng-model-options="{ updateOn: 'blur' }" required>
                              <option value="Si">Si</option>
                              <option value="No">No</option>
                           </select>
                           <p class="obligatorio" ng-show="salidaMaterialesForm.repuesto.$invalid && salidaMaterialesForm.repuesto.$touched">Obligatorio</p>
                        </td>
                        <td>
                           <input class="obligacionTabla" id="ocN1" ng-if="data.singleSelect=='Si'" type="number" name="noOC" ng-model="material.noOC" ng-model-options="{ updateOn: 'blur' }"
                              required/>
                           <input ng-if="data.singleSelect=='No'" type="text" name="noOC" value="N/A" readOnly/>
                          <p class="obligatorio obligatoriedadocN1" style="display:none">Obligatorio</p>
                          <!--  <p class="obligatorio" ng-show="salidaMaterialesForm.noOC.$invalid && salidaMaterialesForm.noOC.$touched">Obligatorio</p> -->
                        </td>
                        
                        
                        <td>
                           <input class="obligacionTabla" id="ocN" ng-if="data.singleSelect=='Si'" type="number" name="noOCa" ng-model="material.noOCa" ng-model-options="{ updateOn: 'blur' }"
                              required/>
                           <input ng-if="data.singleSelect=='No'" type="text" name="noOCa" value="N/A" readOnly/>
                           <p class="obligatorio obligatoriedadocN" style="display:none">Obligatorio</p>
                        ...
                        <!-- datepicker -->
             			...
             			<td>                         
                        <input ng-if="data.regresa=='Si'" type="text" id="datepicker" name="datepicker" class="fec datepicker" readonly/>                 
                           <input ng-if="data.regresa=='No'" class="fec" type="date" ng-model="material.fechaEsperada" readonly/>                        
                        </td>
 						<!-- datepicker -->
 						
                        <td Style="Display:none">
                           <input type="text" value="fechaFinalHome" ng-model="fechaFinalHome" readonly/>
                        </td>
                     </tr>
                     <tr ng-repeat="material in materiales">
                        ...
                        <td class="column-two">
                        	<input ng-if="!habEdit" class="in-descri" type="text" value="material.codigo" name="codigo{{material.ide}}" ng-model="material.codigo" readonly/>
                        	 ...
                        	 <input ng-if="habEdit" class="input-lupa1 obligacionTabla" type="text" id="codigoConsultar{{material.ide}}" name="codigo{{material.ide}}" ng-model="material.codigo" ng-model-options="{ updateOn: 'blur' }" required
                                 />
                              <img ng-if="habEdit" class="imgLupa" src="resources/img/lupa.png" alt="Buscar" ng-click="buscarMaterialLista(material.ide)"/>
                        ...
                        <td class="column-three">                  
                           <input id="contenidoDescrip{{material.ide}}" class="in-descri showTool" type="text" data-toggle="tooltip" title="" value="material.descripcion"
                        ...
                        <td class="column-five"><input class="in-descri" type="number" id="cantidad{{material.ide}}" name="cantidad{{material.ide}}" ng-model="material.cantidad"
                           ng-class="{'campo-editable': habEdit}" ng-readonly="!habEdit" ng-change="vlrEstimadoLista(material.ide)"/></td>
                        <td class="column-six"><input class="in-descri" type="text" id="valor{{material.ide}}" name="valor{{material.ide}}" ng-value="material.vlrUnitario * material.cantidad"
                           readonly/>
                         </td>
                        <td class="column-seven"><input class="in-descri" type="number" name="peso{{material.ide}}" ng-model="material.peso"
                           ng-class="{'campo-editable': habEdit}" ng-readonly="!habEdit" /></td>
                        <td class="column-eight">
                           <input ng-if="!habEdit" class="in-descri" type="text" value="material.regresa" name="regresa{{material.ide}}" ng-model="material.regresa"
                              ng-class="{'campo-editable': habEdit}" ng-readonly="!habEdit" />
                           <select ng-if="habEdit" name="regresa{{material.ide}}" id="regresaList" ng-model="material.regresa" onchange="CallPicker()">
                              <option value="Si">Si</option>
                              <option value="No">No</option>
                           </select>
                        </td>
                        <td class="column-nine">
                           <input ng-if="!habEdit" class="in-descri" type="text" value="material.repuesto" name="repuesto{{material.ide}}" ng-model="material.repuesto"
                              ng-class="{'campo-editable': habEdit}" ng-readonly="!habEdit" />
                           <select ng-if="habEdit" name="repuesto{{material.ide}}" ng-model="material.repuesto">
                              <option value="Si">Si</option>
                              <option value="No">No</option>
                           </select>
                        </td>
                        <td class="column-ten">
                           <input ng-if="data.singleSelect=='Si'" class="in-descri" type="text" value="material.noOC" name="noOc{{material.ide}}" ng-model="material.noOC"
                              ng-class="{'campo-editable': habEdit}" ng-readonly="!habEdit" />
                        ...
                        <td class="column-eleven">
                           <input ng-if="material.regresa=='No'" name="fecha{{material.ide}}" class="in-descri fec" type="date" value="dd/mm/aaaa" readonly/>
                              <!-- picker -->
                              <input ng-if="material.regresa=='Si'" id="fecha{{material.ide}}" name="fecha{{material.ide}}" class="in-descri fec datepicker" type="text" value="material.fechaEsperada" ng-model="material.fechaEsperada" ng-class="{'campo-editable': habEdit}" readonly/>
                        </td>
                        <td>
                        <input ng-if="material.regresa=='No' && material.fechaFinal != null" type="text" class="in-descri fec" value="material.fechaFinal" ng-model="material.fechaFinal" readonly/>
                           <input ng-if="material.regresa=='No' && material.fechaFinal == null" type="text" class="in-descri fec" value="data.fechaFinalisima" ng-model="fechaFinalisima" readonly/>
                        </td>
                        <td class="column-fifteen bote">
                           <input id="chechkPrueba{{material.ide}}" type="checkbox" ng-model="habEdit" />
                           <label class="edit" name="prueba{{material.ide}}" for="chechkPrueba{{material.ide}}"></label>
                           <a class="delete" title="Eliminar" ng-click="removeMaterial(material.fila)"></a>
                        </td>
                     </tr>
                  </tbody>
               </table>
               <p class="obligatorio" ng-show="contador1 === 1 && show">Ingrese por lo menos un material</p>
            </section>
            <span class="separator"></span>
            <section>
               <div class="form-row">
                  <div class="input-block col-full">
                     ...
                     <textarea name="observaciones" ng-model="material.observaciones" rows="7" maxlength="1000" ng-model-options="{ updateOn: 'blur' }" required></textarea>
                     <p class="obligatorio" ng-show="(salidaMaterialesForm.observaciones.$invalid && show) || (salidaMaterialesForm.observaciones.$invalid && salidaMaterialesForm.observaciones.$touched)">Obligatorio</p>
                  </div>
               </div>
            </section>
            <span class="separator"></span>
            <section>
               <div class="form-row">
                  ...
                  <div class="input-block col-quarter" Style="Display:none">
                     ...
                     <input type="text" name="controlPorteria" />
                  </div>
                  <div class="input-block col-quarter" Style="Display:none">
            ...
            <input type="text" id="prueba" name="idFiltrado" value="${model.numVale}" Style="Display:none" />
            <input type="text" id="prueba" name="direccionFiltrada" ng-model="redirecion" Style="Display:none" />
            <input type="text" id="correoUsuario" name="correoUsuario" Style="display:none"/>
      		...
      		<input type="text" id="plantaUsuario" name="plantaUsuario" value="" Style="display:none"/>
      		 <input id="nroFilasTotales" class="contFila" type="text" value="contador2" name="filaTotal" ng-model="contador2" Style="display:none"/>
         </form>
      </div>
      ...
      <div modal="showModal3" close="cancel()" class="modalLista" >
         ...
         <div class="listaEmpresas" style="overflow-y:scroll">
	        ...
	        <div class="modal-body bodyLogin" id="bodyLogin" style="padding:40px 50px;">
	          <form role="form">	        
	            ...
	            <div class="form-group">
	              ...
	              <button type="submit" class="btn btn-success btn-block" onclick="verificarDatos()"><span class="glyphicon glyphicon-off"></span> Login</button>
	          </form>
	        </div>
	      </div>
