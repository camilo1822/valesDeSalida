...
/*
						...
						<input type="text" name="almacen" id="almacenLogeado" readonly/>
									...
									<input type="text" name="" id="almacenLogeado"
										style="display: none" />
									...
									<div class="input-block col-quarter">
										<label class="label">Almacen:</label> <select
											...
											<option value="AprobadoresRepDom">Republica
												Dominicana</option>
										</select>
									</div>
						  ...
						  <option value="SalidaPorteriaMedPpal">Medellín Principal</option>
					...
					<div class="input-block col-quarter">
                     ...
                     <p class="obligatorio" ng-show="(salidaMaterialesForm2.correoPorteria.$invalid && show) || (salidaMaterialesForm2.correoPorteria.$invalid && salidaMaterialesForm2.correoPorteria.$touched)">Obligatorio</p>
								...
								<section class="buttons"> <br> <!-- botones --> <input
									type="button" name="Guardar" value="Aprobar"
									class="submit2 bloqueados" onclick="salidaAlmJ()"
									Style="display: none" /> <input type="button" name="Rechazar"
									value="Rechazar" class="submit2 rechazado bloqueados"
									onclick="rechazar()" Style="display: none" />
								...
								<!-- <input type="submit" name="verPdf" value="verPdf"/> --> <!-- datos usuario -->
								...
								<input type="text" id="descripcionUsuario"
									...
									value="${model.vale.getAprobadorjefe()}" Style="Display: none" />
								<input type="text" id="nameAlm" name="nameAlm"
